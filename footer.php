<footer class="footer">
   ...
   <section class="grid">
      ...
      <div class="box">
         ...
         <a href="mailto:harshchy143@gmail.com"><i class="fas fa-envelope"></i> harshal221715@ncit.edu.np</a>
   ...
   <div class="credit">&copy; copyright @ <?= date('Y'); ?> by <span>HARSHAL DILIP MALI</span> | all rights reserved!</div>
